...
def bacon(args):
    log.info('Executing bacon sub command...')
...
if __name__ == '__main__':
    ...
    parser_bacon.add_argument('--bacon', help='Bacon param')

    parser_kung = subparsers.add_parser('kung')
    parser_kung.add_argument('--kung', help='Kung param')

    parser_foo = subparsers.add_parser('foo')
    parser_foo.add_argument('--foo', help='Foo param')
